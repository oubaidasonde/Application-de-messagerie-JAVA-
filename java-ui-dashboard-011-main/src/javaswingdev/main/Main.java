...
import javaswingdev.form.Inbox;
...
public class Main extends javax.swing.JFrame {
    ...
    public Main() throws MessagingException, AWTException {
        initComponents();
        init();
    }
    
    private void init() throws MessagingException, AWTException {
        main = this;
        titleBar.initJFram(this);
        menu.addEvent(new EventMenuSelected() {
            @Override
            public void menuSelected(int index, int indexSubMenu) throws MessagingException, AWTException {
                if (index == 0 && indexSubMenu == 1) {
                    showForm(new Inbox());
                } else {
